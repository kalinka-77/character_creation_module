...
def attack(char_name: str, char_class: str) -> str:
    """Расчет нанесения урона командой attack."""
    ...
    return ('{char_name} урона не нанёс.')


def defence(char_name: str, char_class: str) -> str:
    """Расчет блока урона командой defence."""
    if char_class == 'warrior':
    ...
    return ('{char_name} не блокировал урон.')


def special(char_name: str, char_class: str) -> str:
    """Расчет применения способности special."""
    if char_class == 'warrior':
        return (f'{char_name}'
    ...
    return ('{char_name} не применил специальное умение.')
